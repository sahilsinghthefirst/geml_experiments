...
MODULES = [
    ...
    "geml.data.dataset",
    "geml.egraph.egraph",
    "geml.egraph.extractor",
    "geml.egraph.ir",
    "geml.egraph.patterns",
    "geml.egraph.rewrites",
    "geml.egraph.rule_sets",
    "geml.egraph.validation",
    "geml.symbolic.ast_graph",
    "geml.symbolic.dag_graph",
    "geml.symbolic.dag_metrics",
    ...
    "geml.experiments.dag_compression_mining",
    "geml.experiments.dag_compression_study",
    "geml.experiments.dag_semantic_audit",
    "geml.experiments.plot_dag_compression",
    "geml.experiments.run_goal3_dag_pipeline",
    "geml.experiments.stratified_dag_compression",
